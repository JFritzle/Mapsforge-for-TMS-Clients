...
pack .title
hyperlink .title https://github.com/JFritzle/Mapsforge-for-TMS-Clients
...
pack .task -in .f -fill x -pady {8 0}
...
proc update_theme_styles_overlays {} {
  ...
  pack configure .styles -in .f -after .themes -fill x -pady 1
  resize_toplevel_window .
}
